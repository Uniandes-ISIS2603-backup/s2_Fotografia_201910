...
insert into PHOTOENTITY (nombre, date, description, price, winner, published, rutaFoto) values ('El presi', '1970-01-01 12:25:06', 'Este es uribe ¿, vale mucho porque es bien famoso', 5000, 8, 8, 'https://www.elheraldo.co/sites/default/files/styles/clavelistamovile/public/articulo/2017/05/09/alvaro-uribe-le-responde-al-contralor-sobre-sus-predios_0.jpg?itok=efvMFyQL');
insert into PHOTOENTITY (nombre, date, description, price, winner, published, rutaFoto) values ('Atardecer en cartagena', '1970-01-01 12:25:06', 'Un atardecer bien tarde', 9000, 8, 8, 'https://www.turismodeobservacion.com/media/fotografias/atardecer-en-cortegana-3123-xl.jpg');
...
insert into PHOTOENTITY (nombre, date, description, price, winner, published, rutaFoto) values ('India verde', '1970-01-01 12:25:06', 'Ojos verdes en India', 790, 8, 8, 'https://mott.pe/noticias/wp-content/uploads/2017/10/Conoce-cu%C3%A1les-son-las-mejores-im%C3%A4genes-art%C3%ADsticas-capturadas-a-trav%C3%A9s-de-fotograf%C3%ADas-famosas.jpg');
insert into PHOTOENTITY (nombre, date, description, price, winner, published, rutaFoto) values ('Niña y su gato', '1970-01-01 12:25:06', 'Gato en la silla', 1500, 8, 8, 'https://bigotesdegato.com/wp-content/uploads/2013/10/La-bella-historia-de-amistad-entre-una-ni%C3%B1a-y-su-gato-05.jpg');
...
insert into PHOTOENTITY (id, nombre, date, description, price, winner, published, rutaFoto, FOTOGRAFO_ID, INTERES_ID) values (807, 'Caño cristales', '1970-01-01 12:25:06', 'El rio de los siete colores',85,8,8,'https://www.colombiatudestino.com/viajes/wp-content/uploads/2018/09/cristales3.jpg',3, 1);
