...
import co.edu.uniandes.csw.fotografia.resources.JuradoResource;
...
public class JuradoIT {
    private static final String COLLECTION = "JuradoResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "frontstepbystep-api.war")//War del modulo api
                ...
                .addPackage(JuradoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(JuradoDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
