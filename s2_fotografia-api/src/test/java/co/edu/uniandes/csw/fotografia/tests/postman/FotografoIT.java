...
/**
 *  Pruebas de integracion del recurso de Fotografo.
 * @author s.acostav
 */
@RunWith(Arquillian.class)
public class FotografoIT {

    private static final String COLLECTION = "Fotografo-Tests-Paso5.postman_collection";
