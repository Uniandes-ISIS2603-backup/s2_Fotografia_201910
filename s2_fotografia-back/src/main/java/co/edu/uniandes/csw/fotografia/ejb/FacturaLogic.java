...
public class FacturaLogic {
     ...
     * @throws BusinessLogicException si la factura creada no cumple con alguna
    ...
    public FacturaEntity createFactura(FacturaEntity factura) throws BusinessLogicException {
        ...
        //Verificar la regla de negocio que afirma que no deben haber dos facturas con el mismo numero, y que no debe ser null
        if (factura.getNumero() == null) {
            throw new BusinessLogicException("El numero de la factura no puede ser null");
        } else {
            if (fp.getByNumero(factura.getNumero()) != null) {
                throw new BusinessLogicException("Ya existe una factura con el numero ingresado");
            }
        ...
        //Verifica la regla de negocio que prohibe que el precio en la factura sea negativo y null
        if (factura.getPrecio() == null) {
            throw new BusinessLogicException("El precio no puede ser null");
        } else {
        ...
        //Verifica la regla de negocio que prohibe que la fecha sea mayor a la actual o que sea null
        if (factura.getFechaCompra() == null) {
            throw new BusinessLogicException("La fecha de la factura no puede ser null");
        } else {
    ...
    public FacturaEntity setFactura(Long facturaId, FacturaEntity factura) throws BusinessLogicException {
        ...
        if (factura.getNumero() == null) {
            ...
            if (fp.get(facturaId).getNumero() != factura.getNumero()) {
                if (fp.getByNumero(factura.getNumero()) != null) {
