...
/**
 * Pruebas de logica de la relacion Concurso - Organizadors
 *
 * @author n.rincond
 */
@RunWith(Arquillian.class)
public class ConcursoOrganizadorLogicTest {
    ...
    @Inject
    private ConcursoOrganizadorLogic concursoOrganizadorLogic;
    ...
    private void insertData() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            data.add(entity);
            if (i == 0) {
                concursosData.get(i).setOrganizador(entity);
            }
        }
    }
    ...
    public void replaceOrganizadorTest() {
        ...
        concursoOrganizadorLogic.replaceOrganizador(entity.getId(), data.get(1).getId());
        entity = concursoLogic.getConcurso(entity.getId());
        Assert.assertEquals(entity.getOrganizador(), data.get(1));
    }

    /**
     * Prueba para desasociar un Concurso existente de un Organizador existente
     *
    ...
    public void removeConcursosTest() throws BusinessLogicException {
        concursoOrganizadorLogic.removeOrganizador(concursosData.get(0).getId());
